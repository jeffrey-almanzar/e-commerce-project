          ...
          <nav className="whole-nav">
            ...
            >
              <ul>
                ...
                <li id="sign-in" onClick={this.logout} role="button">
                  <Link to="/">Log out</Link>
                </li>
                <li id="cart" role="button">
                  <Link to="/cart">
                    <span className="cart-link">Cart</span>
                    <span className="cart-size">{this.props.cartSize}</span>
                    <img
                      src="https://cdn.dribbble.com/users/1146750/screenshots/2737669/savr-cart_small.gif"
                      alt="img"
                    />
                  </Link>
                </li>
