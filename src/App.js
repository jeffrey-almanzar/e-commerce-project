...
class App extends React.Component {
  ...
  componentDidMount() {
    axios.get("https://e-ommerce-server.herokuapp.com/products").then(res => {
      let product = [];
    ...
    axios
      .get(
        "https://e-ommerce-server.herokuapp.com/cartProducts/" +
  ...
  addToCart = product => {
    this.setState(state => {
      ...
      if (notInCart && this.state.login) {
        axios
          .post("https://e-ommerce-server.herokuapp.com/addToCart", {
  ...
  componentDidUpdate() {
    if (this.deletedItem.name) {
      axios
        .delete(
          "https://e-ommerce-server.herokuapp.com/removeItem/" +
  ...
  render() {
    const ShowProductComponent = info => {
      return (
        <ShowProduct
          info={info}
          cartSize={this.state.shoppingCart.length}
